    ...
    <div class="edit-container">
        ...
        <div class="edit-container-bottom">
            <div class="dict-chapter-word-add">
                <el-button type="primary" @click="handleEditDictFinish">确定</el-button>
            </div>
        </div>
...
const initData = () => {
    tempDict.value = cloneDeep(props.editDict)
    dictWords = props.editDict.chapterWords.flat()
    currentChapterWords.value = tempDict.value.chapterWords[0]
}
